...
function buildFaqSchema() {
 ...
 acceptedAnswer: {
 '@type': 'Answer',
 text: 'HP Тюнинг работает напрямую с производителями ПО (Alientech, Dimsport, CMD), без посредников и накруток. Наши цены ниже крупных сетевых студий на 500–1 000 ₽ при том же качестве калибровок.',
 },
 },
 ],
 }
