...
const FAQ = [
 ...
 { q: 'Что входит в стоимость ремонта двигателя?', a: 'Работы по разборке, дефектовке, ремонту и сборке, расходники (масло, антифриз, прокладки, сальники). Запчасти — отдельной строкой по согласованию с клиентом: оригинал или проверенный OEM-аналог (Febi, Meyle, Bosch).' },
];
