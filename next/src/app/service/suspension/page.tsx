...
export const metadata: Metadata = {
 ...
 description: 'Ремонт ходовой части в Санкт-Петербурге: замена амортизаторов от 8 000 ₽, сайлентблоков от 3 500 ₽, рычагов, стоек. BMW, Mercedes, Audi, Porsche, Land Rover. Диагностика на стенде.',
...
const STEPS = [
 { step: '01', title: 'Диагностика', desc: 'Подвеска проверяется на вибростенде, выявляем стуки, люфты и износ сайлентблоков.' },
 { step: '02', title: 'Дефектовка', desc: 'Поднимаем авто на подъёмнике, фотографируем износ и согласуем список работ.' },
 { step: '03', title: 'Замена', desc: 'Меняем амортизаторы, пружины, рычаги, сайлентблоки. Только OEM или проверенные аналоги.' },
 { step: '04', title: 'Развал-схождение', desc: 'После ремонта подвески — обязательная регулировка геометрии на 3D-стенде.' },
];
...
<script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(serviceSchema) }} />
 ...
 <Breadcrumbs items={[{ label: "Автосервис", href: "/service" }, { label: "Подвеска" }]} />
 ...
 <div className="font-display text-3xl text-purple-400/30 mb-3">{s.step}</div>
