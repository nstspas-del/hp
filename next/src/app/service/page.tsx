...
const FAQ = [
 ...
 {
 q: 'Как проходит приёмка автомобиля в сервис?',
 a: 'Принимаем по записи, фиксируем пробег и состояние авто. Мастер согласует объём работ и стоимость до начала ремонта — без скрытых доплат.',
 },
 {
 ...
 {
 q: 'Где вы находитесь?',
 a: 'Мы в Санкт-Петербурге, ул. Богородская, 3Б (Порошкино). Работаем ежедневно с 10:00 до 22:00.',
 },
];
