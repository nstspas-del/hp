...
const DIRECTIONS = [
 ...
 desc: 'Тюнинг и чип-тюнинг — прирост мощности от +15% до +80%. Удаление сажевого, EGR, Immo. Фирменный OBD-доступ к каждой марке.',
 price: 'от 24 000 ₽',
 accent: '#39FF14',
 links: [
 { label: 'Чип-тюнинг', href: '/tuning/chip-tuning' },
 { label: 'Аппаратный тюнинг', href: '/tuning' },
