...
const NAV = [
 ...
 { label: 'Все услуги сервиса →', href: '/service', desc: '' },
 ],
 },
 {
 label: 'Марки',
 ...
 { label: 'Тюнинг салона', href: '/tuning/interior', desc: 'Карбон, алькантара, подсветка' },
 ],
 },
 {
 label: 'Детейлинг',
 ...
 { label: 'PPF плёнка', href: '/detailing/ppf', desc: 'XPEL, SunTek — полная защита кузова' },
 { label: 'Полировка', href: '/detailing/polish', desc: 'Коррекция царапин, глубокий блеск' },
